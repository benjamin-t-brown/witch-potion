...
rl.question(
  ...
  (seconds) => {
    ...
    exec(
      `node ${__dirname}/../node_modules/roadroller/cli.mjs ${__dirname}/../output.js -D -OO`,
      { timeout: seconds * 1000, killSignal: 'SIGINT', maxBuffer: 4069 * 1024 },
      (error, stdout, stderr) => {
        ...
        console.log('huh?', error, stdout, stderr);
